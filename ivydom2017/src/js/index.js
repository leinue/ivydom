$(function() {
  ...
  (function() {
    ...
    $('#worksModal, #introModal, #contactModal, #blogModal').on('hidden.bs.modal', function (e) {
      $('.header-bio').show();
    });

    $('.bio-menu ul li a').click(function() {
    ...
    productsItem.hover(function() {
      var _this = $(this),
          thisIcon = _this.find('.main-prod-icon'),
          thisMainProdText = _this.find('.main-prod-text');
